<div id="monerisCheckout" style="z-index:9999;"></div>

<?php if ($vars->environment == 'prod') { ?>
  <script>
...
<?php if ($vars->ticket) { ?>
  <script>
    ...
    myCheckout.setMode("<?php echo $vars->environment; ?>");
    myCheckout.setCheckoutDiv("monerisCheckout");
    myCheckout.startCheckout("<?php echo $vars->ticket; ?>");
    ...
    var myCancelTransaction = function (data) {
      ...
      setTimeout(function () {
        ...
        window.location.replace("<?php echo $vars->redirect; ?>");
      }, 1000)
    };
